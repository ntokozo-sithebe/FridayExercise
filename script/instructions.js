...
document.getElementsByClassName('paragraph').innerText = 'This is a language I have mastered and I am proud of myself. I complished this because I believed in myself'

// 3. Use the h3 element and change the heading(Subheading) to 'Things I've accomplished so far'. Hint: use querySelector
document.querySelector('[h3]').innerText = 'Things I have accomplished so far'
...
document.querySelectorAll('[h3]').innerText = 'I have discovered that I can accomplish anything I put my mind to'
